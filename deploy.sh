fission spec init
fission env create --spec --name onb-br-enum-doc-tp-env --image nexus.sigame.com.br/fission-onboarding-br-enum-document-type:0.1.0 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
